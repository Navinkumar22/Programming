...
The program must interchange the values in the diagonals of the matrix. 
...
Explanation: The main diagonal elements are 5 2 3 The opposite diagonal elements are 6 2 8 In the 1st row, 
interchange 5 and 6 In the 2nd row, 2 is common for both the diagonals. Hence no need to interchange. 
