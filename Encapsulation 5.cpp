/*
Exercise 5
Create the class CardBinder which stores integer values of gold_card and silver_card. Assume that a CardBinder object can only hold at maximum 20 total cards of gold_card and silver_card combined.
Given Code
Requirements
